...
Privado, Público). El SOC investiga conexiones que salen hacia IPs
...
Firewall → túneles por DNS o HTTPS (puerto 443)
...
Ninguna capa es perfecta. Por eso las organizaciones suman **EDR +
Firewall + SIEM + SOC**. El analista busca la **falla en la cadena**:
...
Se detecta que un binario se comunicó por HTTPS (443) hacia una IP
