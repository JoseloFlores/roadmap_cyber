...
-   Correlacionar Event IDs (4625 → 4624 → 4688 → red).
-   Usar una línea de tiempo para ordenar los hechos.
-   Redactar un veredicto y las siguientes acciones.
-   Conectar lo aprendido con las próximas fases (Sysmon, SIEM).
...
10:34 — conexión TCP 443 a 203.0.113.50
...
1.  Resumen (qué pasó).
2.  Línea de tiempo.
3.  Evidencia (Event IDs, IPs, rutas).
