...
- Interpretar los conceptos de PID y PPID.
...
Abre dos terminales y ejecuta el mismo comando: el programa es el mismo,
...
Una **reverse shell** aparece como un proceso de red inusual.
...
Cuando llega una alerta al SIEM, el primer paso suele ser: ¿qué proceso
generó este evento?
...
root 1 0.0 0.0 166000 11660 ? Ss 09:15 0:01 /sbin/init

www-data 732 0.1 0.5 230000 45000 ? S 09:16 0:02 nginx: worker

jo 1240 2.3 1.2 340000 90000 pts/0 S 10:02 0:05 bash
...
El kernel mata el proceso de inmediato.
...
Un **daemon** es un proceso que corre en segundo plano sin interacción
del usuario.
