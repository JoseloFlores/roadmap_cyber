...
**Módulo 11 – DHCP (Dynamic Host Configuration Protocol)**
...
Entrega IP, máscara, gateway y DNS sin intervención manual.
...
- Explicar el proceso DORA paso a paso.

- Conocer los puertos UDP 67 y UDP 68.

- Entender el concepto de concesión (lease) y su renovación.

- Diferenciar IP estática e IP dinámica.

- Conocer los componentes de un servidor DHCP.

- Identificar ataques como Rogue DHCP y DHCP Starvation.

- Interpretar eventos DHCP en un SIEM.
...
Un servidor DHCP reparte IPs y otros datos de configuración a los equipos.
...
Envía un mensaje a todos (broadcast):
...
TCP necesita una conexión previa (Three-Way Handshake).
...
La reserva se hace según la **dirección MAC**.
...
Todos comparten el mismo **Transaction ID** (por ejemplo, 0x3f2a1b).
...
**Ataque 3 – DHCP Spoofing para MITM**
