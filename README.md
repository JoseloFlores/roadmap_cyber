...
3. **[Módulo 23. Usuarios, grupos y autenticación](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/23_Usuarios_Grupos_Autenticacion.md)**: Cuentas locales, RID/SID, SAM, UAC, mínimo privilegio, NTLM vs Kerberos y Active Directory (dominio, DC, OU, GPO, KDC/TGT/TGS/SPN, Kerberoasting, Pass-the-Ticket, Golden Ticket), con 3 exámenes de 10 preguntas.
4. **[Módulo 24. Procesos y servicios](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/24_Procesos_Servicios.md)**: `tasklist`/`taskkill`, proceso padre/hijo y process tree, `svchost`, `lsass`, ruta y Masquerading, persistencia por servicios, Process Injection y Living off the Land, con doble examen.
5. **[Módulo 25. CMD y PowerShell](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/25_CMD_PowerShell.md)**: Guía completa `whoami`, `ipconfig`, `netstat -ano`, `tasklist`, objetos PowerShell, `CommandLine`, ofuscación/`-enc`, logging y correlación con procesos/servicios, con examen ampliado + desafío SOC.
6. **[Módulo 26. Windows Event Logs](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/26_Windows_Event_Logs.md)**: Visor de eventos, Event IDs clave (4624, 4625, 4688, 4720, 7045, 1102), Logon Types, Source Network Address, PowerShell logging, correlación 4625→4624→4688→red y profundización 4624/4625/4688, con doble examen.
7. **[Módulo 27. Seguridad de Windows](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/27_Seguridad_Windows.md)**: Defender (firmas vs comportamiento), Firewall, UAC, Update, BitLocker, Credential Guard, SmartScreen, AppLocker/WDAC y defensa en profundidad (EDR+SIEM+SOC).
8. **[Módulo 28. Windows desde la perspectiva del atacante](file:///home/jo/Documentos/road_map_cyber/Fase_1_Fundamentos/Semana_4_Windows/28_Windows_Perspectiva_Atacante.md)**: Attack lifecycle completo, descubrimiento, escalada, credenciales, persistencia, movimiento lateral, evasión, Living off the Land, baseline/anomalía, IOC/IOA y examen general de Windows de 20 preguntas.
